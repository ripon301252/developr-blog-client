...
const BlogList = ({
  ...
  return (
    <div className="space-y-4 max-h-[600.9px] overflow-y-auto hide-scrollbar">
      {/* HEADER */}
      <div
        className="
...
"
  ...
  "
      ...
      ${
        isOwner
          ? "bg-red-500/10 border-red-400/30 text-red-400 hover:bg-red-500/20 hover:shadow-[0_0_12px_rgba(239,68,68,0.5)] hover:scale-110 active:scale-95"
    ...
    `}
      ...
      ${
        isOwner
          ? "bg-green-500/10 border-green-400/30 text-green-400 hover:bg-green-500/20 hover:shadow-[0_0_12px_rgba(34,197,94,0.5)] hover:scale-110 active:scale-95"
          : "bg-gray-500/10 border-gray-400/20 text-gray-400 cursor-not-allowed"
      }
    `}
                >
      ...
      <dialog id="edit_modal" className="modal">
        <div className="modal-box bg-white/10 backdrop-blur-lg border border-green-400/30 shadow-2xl rounded-2xl w-11/12 max-w-lg">
          <h3 className="font-bold text-xl text-green-400 mb-4 text-center">
            ✏️ Edit Blog
          </h3>
          ...
          <div className="mt-5 flex flex-col sm:flex-row justify-end gap-3">
            <button
              ...
              disabled={updating}
              className="px-5 py-2 rounded-xl bg-green-500 hover:bg-green-600 transition text-white font-semibold disabled:opacity-50"
            >
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl border border-red-400 text-red-400 hover:bg-red-500 hover:text-white transition"
            >
              ❌ Cancel
            </button>
          </div>
