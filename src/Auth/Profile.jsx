        ...
        <div className="w-full max-w-4xl bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 text-center ">
            ...
            <button
              onClick={handleSave}
              disabled={loading}
              className="mt-6 px-8 py-3 bg-gradient-to-r from-cyan-400/50 to-cyan-600/50 cursor-pointer rounded-full font-semibold hover:scale-105 transition-all duration-200 disabled:opacity-50"
            >
